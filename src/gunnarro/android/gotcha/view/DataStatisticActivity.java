...
public class DataStatisticActivity extends Activity implements OnClickListener {
	...
	private void updateDataStatistic() {
		TableLayout table = (TableLayout) findViewById(R.id.tableLayout1);
		...
		for (SMS sms : smsInbox) {
			...
			summarySMS.increaseNumberOfReceived(sms.getNumberOfSent());
